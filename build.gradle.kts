...
dependencies {
    implementation("org.jetbrains.kotlinx:dataframe:0.13.1-dev-3115")
    kotlinCompilerPluginClasspath("org.jetbrains.kotlinx.dataframe:compiler-plugin-all:0.13.1-dev-3115")
