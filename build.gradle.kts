...
dependencies {
    implementation("org.jetbrains.kotlinx:dataframe:0.16.0-dev-5585")
    kotlinCompilerPluginClasspath("org.jetbrains.kotlinx.dataframe:compiler-plugin-all:0.16.0-dev-5585")
